...
def build_report(df: pd.DataFrame, top_n: int = 10) -> str:
    ...
    return "".join(
        [
            ...
            "- The highest-missingness columns above are the priority "
            "data-quality gaps.\n",
            "- Treat high-missing categorical fields as 'Unknown' rather than "
            "dropping rows.\n",
            "- No imputation is applied here; missing values are left as NA "
